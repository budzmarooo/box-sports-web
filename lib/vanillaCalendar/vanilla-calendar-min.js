  ...
  return function(t) {
    ...
    (this.init = function() {
      (document.querySelector(n.selector).innerHTML =
        '\n            <div class="calendar" clavanilla-calendar-btnss="vanilla-calendar-header" >\n                <button type="button" class="vanilla-calendar-btn prev" data-calendar-toggle="previous"><img src="./assets/img/step2Icons/iconleft.png"></button>\n                <div class="vanilla-calendar-header__label" data-calendar-label="month"></div>\n                <button type="button" class="vanilla-calendar-btn next" data-calendar-toggle="next"><img src="./assets/img/step2Icons/iconright.png"></button>\n            </div>\n            <div class="vanilla-calendar-week"></div>\n            <div class="vanilla-calendar-body" data-calendar-area="month"></div>\n            '),
